...
<p style="color:#A5A5A5;font-size: 15px;margin-top: -15px;">Preencha os Dados do Cliente</p>
 
<br>
<form class="form" action="insertCliente.php" method="POST">
    <input placeholder="  Nome do Cliente" type="text" class="input" style="margin-bottom: 11px;" name="nomeCliente" id="nomeCliente">
  
    <input placeholder="  Sobrenome" type="text" class="input" style="margin-bottom: 11px;" name="sobrenomeCliente" id="sobrenomeCliente">
   
    <input placeholder="  Email" type="text" class="input" style="margin-bottom: 11px;" name="emailCliente" id="emailCliente">
   
    <input placeholder="  Telefone" type="text" class="input" style="margin-bottom: 11px;" name="telefoneCliente" id="telefoneCliente">
    
    <input placeholder="  Endereco (Bairro, Rua, Num.)" type="text" class="input" style="margin-bottom: 11px;" name="enderecoCliente" id="enderecoCliente">
