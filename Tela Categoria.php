...
body{
    ...
    align-items: center;
    background: url(nnathan-dumlao-OTq59L9RbEk-unsplash.jpg);
...
<div class="card">
<center>
    <h2>Cadastro<label style="color:#1CA8FF"> Categoria</label></h2>
<p style="color:#A5A5A5;font-size: 15px;margin-top: -15px;">Prencha as informações da Categoria</p>
 
<br>
<form class="form" action="categoria.php" method="POST">
   <input placeholder="  Nome Categoria" type="text" class="input" style="margin-bottom: 11px;" name="nmCategoria" id="nmCategoria">
